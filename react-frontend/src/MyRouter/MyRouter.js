...
import SingleMemberProfilePage from "../components/MemberProfilePage/SingleMemberProfilePage";
import MemberProfileProjectLayoutPage from "../components/MemberProfilePage/MemberProfileProjectLayoutPage";
import SinglePaymentsPage from "../components/PaymentsPage/SinglePaymentsPage";
import PaymentProjectLayoutPage from "../components/PaymentsPage/PaymentProjectLayoutPage";
import SingleJobApplicationsPage from "../components/JobApplicationsPage/SingleJobApplicationsPage";
import JobApplicationProjectLayoutPage from "../components/JobApplicationsPage/JobApplicationProjectLayoutPage";
import SingleJobsPage from "../components/JobsPage/SingleJobsPage";
import JobProjectLayoutPage from "../components/JobsPage/JobProjectLayoutPage";
import SingleScholarshipApplicationsPage from "../components/ScholarshipApplicationsPage/SingleScholarshipApplicationsPage";
import ScholarshipApplicationProjectLayoutPage from "../components/ScholarshipApplicationsPage/ScholarshipApplicationProjectLayoutPage";
import SingleScholarshipsPage from "../components/ScholarshipsPage/SingleScholarshipsPage";
import ScholarshipProjectLayoutPage from "../components/ScholarshipsPage/ScholarshipProjectLayoutPage";
import SingleJobApplicationReviewPage from "../components/JobApplicationReviewPage/SingleJobApplicationReviewPage";
import JobApplicationReviewProjectLayoutPage from "../components/JobApplicationReviewPage/JobApplicationReviewProjectLayoutPage";
import SingleScholarshipApplicationReviewPage from "../components/ScholarshipApplicationReviewPage/SingleScholarshipApplicationReviewPage";
import ScholarshipApplicationReviewProjectLayoutPage from "../components/ScholarshipApplicationReviewPage/ScholarshipApplicationReviewProjectLayoutPage";
import SingleEducationPage from "../components/EducationPage/SingleEducationPage";
import EducationProjectLayoutPage from "../components/EducationPage/EducationProjectLayoutPage";
import SingleExperiencePage from "../components/ExperiencePage/SingleExperiencePage";
import ExperienceProjectLayoutPage from "../components/ExperiencePage/ExperienceProjectLayoutPage";
import SingleInstitutionsPage from "../components/InstitutionsPage/SingleInstitutionsPage";
import InstitutionProjectLayoutPage from "../components/InstitutionsPage/InstitutionProjectLayoutPage";
import SingleMemberInstitutionsPage from "../components/MemberInstitutionsPage/SingleMemberInstitutionsPage";
import MemberInstitutionProjectLayoutPage from "../components/MemberInstitutionsPage/MemberInstitutionProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/memberProfile/:singleMemberProfileId" exact element={<SingleMemberProfilePage />} />
<Route path="/memberProfile" exact element={<MemberProfileProjectLayoutPage />} />
...
<Route path="/jobApplications/:singleJobApplicationsId" exact element={<SingleJobApplicationsPage />} />
<Route path="/jobApplications" exact element={<JobApplicationProjectLayoutPage />} />
<Route path="/jobs/:singleJobsId" exact element={<SingleJobsPage />} />
<Route path="/jobs" exact element={<JobProjectLayoutPage />} />
<Route path="/scholarshipApplications/:singleScholarshipApplicationsId" exact element={<SingleScholarshipApplicationsPage />} />
<Route path="/scholarshipApplications" exact element={<ScholarshipApplicationProjectLayoutPage />} />
<Route path="/scholarships/:singleScholarshipsId" exact element={<SingleScholarshipsPage />} />
<Route path="/scholarships" exact element={<ScholarshipProjectLayoutPage />} />
<Route path="/jobApplicationReview/:singleJobApplicationReviewId" exact element={<SingleJobApplicationReviewPage />} />
<Route path="/jobApplicationReview" exact element={<JobApplicationReviewProjectLayoutPage />} />
<Route path="/scholarshipApplicationReview/:singleScholarshipApplicationReviewId" exact element={<SingleScholarshipApplicationReviewPage />} />
<Route path="/scholarshipApplicationReview" exact element={<ScholarshipApplicationReviewProjectLayoutPage />} />
<Route path="/education/:singleEducationId" exact element={<SingleEducationPage />} />
<Route path="/education" exact element={<EducationProjectLayoutPage />} />
<Route path="/experience/:singleExperienceId" exact element={<SingleExperiencePage />} />
<Route path="/experience" exact element={<ExperienceProjectLayoutPage />} />
<Route path="/institutions/:singleInstitutionsId" exact element={<SingleInstitutionsPage />} />
<Route path="/institutions" exact element={<InstitutionProjectLayoutPage />} />
<Route path="/memberInstitutions/:singleMemberInstitutionsId" exact element={<SingleMemberInstitutionsPage />} />
<Route path="/memberInstitutions" exact element={<MemberInstitutionProjectLayoutPage />} />
