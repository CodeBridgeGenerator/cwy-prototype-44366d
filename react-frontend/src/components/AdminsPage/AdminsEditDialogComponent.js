...
password: _entity?.password,
        ...
        const result = await client.service("admins").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info admins updated successfully" });
    ...
    return (
        <Dialog header="Edit Admins" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="admins-edit-dialog-component">
