...
const SingleAdminsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("admins")
            .get(urlParams.singleAdminsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleAdminsId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                ...
                <p>admins/{urlParams.singleAdminsId}</p>
                {/* ~cb-project-dashboard~ */}
            </div>
            <div className="card w-full">
                <div className="grid ">

            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">AdminID</label><p className="m-0 ml-3" >{_entity?.AdminID}</p></div>
...
export default connect(mapState, mapDispatch)(SingleAdminsPage);
