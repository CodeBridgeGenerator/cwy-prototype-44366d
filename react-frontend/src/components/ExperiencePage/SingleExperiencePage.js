...
const SingleExperiencePage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("experience")
            .get(urlParams.singleExperienceId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleExperienceId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                ...
                <p>experience/{urlParams.singleExperienceId}</p>
...
export default connect(mapState, mapDispatch)(SingleExperiencePage);
