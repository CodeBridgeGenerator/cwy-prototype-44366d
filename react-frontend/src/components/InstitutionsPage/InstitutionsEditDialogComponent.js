...
const InstitutionsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            InstitutionName: _entity?.InstitutionName,
...
name: _entity?.name?._id,
        ...
        await client.service("institutions").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info institutions updated successfully" });
    ...
    return (
        <Dialog header="Edit Institutions" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="institutions-edit-dialog-component">
