...
const SingleInstitutionsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleInstitutionsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleInstitutionsId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Institutions</h3>
                </div>
                <p>institutions/{urlParams.singleInstitutionsId}</p>
                {/* ~cb-project-dashboard~ */}
            </div>
            <div className="card w-full">
                <div className="grid ">

            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Institution Name</label><p className="m-0 ml-3" >{_entity?.InstitutionName}</p></div>
...
export default connect(mapState, mapDispatch)(SingleInstitutionsPage);
