...
jobRequirements: _entity?.jobRequirements,
...
salary: _entity?.salary,
        ...
        const result = await client.service("jobs").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info jobs updated successfully" });
    ...
    return (
        <Dialog header="Edit Jobs" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="jobs-edit-dialog-component">
