...
approvalStatus: _entity?.approvalStatus,
        ...
        await client.service("jobApplicationReview").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info jobApplicationReview updated successfully" });
...
const adminOptions = admin.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Edit JobApplicationReview" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="jobApplicationReview-edit-dialog-component">
